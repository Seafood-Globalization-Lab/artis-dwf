...
#                                x.lab = "Quantity (tons live weight)") +
#   scale_x_continuous(labels = scales::comma) +
#   # add quantity labels for values less than max value (outside of bar)
#   geom_shadowtext(
#     data = subset(top_6_sp_dwf, live_weight_t < max(top_6_sp_dwf$live_weight_t)), 
...
#     bg.r = 0.2,
#     size = 3) +
#   # add quantity label for max value (inside bar)
#   geom_text(
#     data = subset(top_6_sp_dwf, live_weight_t == max(top_6_sp_dwf$live_weight_t)),
#     aes(live_weight_t, y = common_name, 
#         label = scales::comma(round(live_weight_t))),
#     hjust = 0,
#     nudge_x = -max(top_6_sp_dwf$live_weight_t)*0.1,
#     colour = "white",
#     size = 3
# )
...
exploreARTIS::plot_bar(data = top_6_sp_dwf,
  ...
  geom_shadowtext(
    data = subset(top_6_sp_dwf, live_weight_t < max(top_6_sp_dwf$live_weight_t) * 0.8), 
    aes(x = live_weight_t, y = common_name, 
        label = scales::comma(round(live_weight_t))),
    hjust = 0,
...
#   # add quantity labels for values less than max value (outside of bar)
#   geom_shadowtext(
#     data = top_6_sp_consum,
#     aes(x = live_weight_t, y = common_name, 
#         label = scales::comma(round(live_weight_t))),
#     hjust = 0,
#     nudge_x = 0.025*top_6_sp_consum$live_weight_t,
#     colour = "#114F59", #default RGB color from plot_bar
#     bg.colour = "white",
#     bg.r = 0.2,
#     size = 3) 
...
exploreARTIS::plot_bar(data = top_6_sp_consum,
  ...
  # Add quantity labels for values below the threshold (outside of bar)
  geom_shadowtext(
    data = subset(top_6_sp_consum, live_weight_t < max(top_6_sp_consum$live_weight_t) * 0.8), 
    aes(x = live_weight_t, y = common_name, 
        label = scales::comma(round(live_weight_t))),
    hjust = 0,
