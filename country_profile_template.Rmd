...
```{r figs-sankeys-eez-frgn-species, results='hide', fig.keep='all', fig.cap=paste0(top_6_sp_dwf$common_name, ": caught via DWF in ", country_name, "'s EEZ waters. Total catch for all years of available data (", paste(unique(country_i_eez_fishing$year), collapse = ", "),")")}
# New Figure -- 
