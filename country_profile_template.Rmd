...
params: 
  ...
  country_i_dom_consump: NULL
  country_i_eez_fishing: NULL
  country_i_dom_fishing: NULL
---
...
# pull out parameters to Rmd environment
...
exploreARTIS::plot_bar(country_i_dwf_5,
                       bar_group ="sciname")
#FIXIT plot.title argument currently does not change title
```
...
```{r, eval=FALSE}
top_sp_consump <- country_i_dwf_5 %>% 
  filter()

unique(top_6$sciname)
exploreARTIS::plot_ts(country_i_dwf_5,
                      artis_var = "producer_iso3c",
                      #plot.title = "DWF Catch by EEZ",
                      prop_flow_cutoff = 0.05,
                      plot.type = "stacked",
